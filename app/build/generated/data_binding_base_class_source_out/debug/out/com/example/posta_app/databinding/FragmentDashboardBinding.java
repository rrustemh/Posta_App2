...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  private FragmentDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView deliveriesRecyclerView) {
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView deliveriesRecyclerView = rootView.findViewById(id);
      if (deliveriesRecyclerView == null) {
        break missingId;
      }

      return new FragmentDashboardBinding((ConstraintLayout) rootView, deliveriesRecyclerView);
    }
